...
- Preview a blog generation run locally:
...
Validated posts now publish by default so they appear on the website without a second manual status flip. If you want to keep a run off the live site, set `BLOG_PUBLISH_MODE=draft`.
